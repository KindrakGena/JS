...
let simpsons = [
 ...
 //     document.write(`<div style="line-height: 27px; font-size: 20px">
 // NAME - ${simpson.name} ;
 //  SURNAME - ${simpson.surname} ;
 //  AGE - ${simpson.age} ;
 //  INFO - ${simpson.info} ;
 //  <div> <img src="${simpson.photo}"></div>`)
 // }
 // document.write('</div>')
...
//     document.write(`<p style="font-size: 19px; line-height: 25px"> ${simpson.info}</p>`);
//     document.write('</div>')
...
//     document.write(`<h3 class="product-titl"> ${product.title}. Price - ${product.price}</h3>`);
//     document.write(`<img class="product-image" src="${product.image}">`)
//     document.write('</div>');
// }
// document.write('</div>');
